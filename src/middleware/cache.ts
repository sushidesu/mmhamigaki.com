...
const kvConfigs: KVCacheConfig[] = [
  { pattern: /^\/posts\/[^\/]+$/, keyPrefix: 'post:html:', ttl: 3600, contentType: 'text/html; charset=utf-8' },
  { pattern: /^\/$/, keyPrefix: 'homepage:', ttl: 3600, contentType: 'text/html; charset=utf-8' },
  { pattern: /^\/og-image\/[^\/]+$/, keyPrefix: 'metadata:', ttl: 86400, contentType: 'image/svg+xml' },
]
